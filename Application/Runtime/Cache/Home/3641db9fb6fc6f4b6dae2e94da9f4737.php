...
<head>
    ...
    <link href="/share/Public/Home/css/classify.css" rel="stylesheet">
...
<div class="container">
    ...
    <?php $__FOR_START_392286510__=0;$__FOR_END_392286510__=$end;for($i=$__FOR_START_392286510__;$i < $__FOR_END_392286510__;$i+=1){ if($i%4==0){ ?>
            <div class="row">
        <?php } ?>
        <div class="col-sm-6 col-md-3 col-xs-6">
            <a href="<?php echo U('Detail/index',['vid'=>$videosList[$i]['id']]);?>" target="_blank">
                <div class="e8-list thumbnail">
                    <img src="/share/<?php echo ($videosList[$i]["cover"]); ?>" />
                    <div class="caption">
