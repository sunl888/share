...
<head>
    ...
    <link rel="stylesheet" href="/share/Public/Home/css/video-js.css">
    <link href="/share/Public/Home/css/play.css" rel="stylesheet">
    <style>
        i{cursor: pointer;}
...
<div class="play_main">
    <div class="text-center play_body">
        <video id="example_video1" class="video-js vjs-default-skin" controls preload="none" width="100%" height="100%"
            poster="/share/<?php echo ($videoInfo["cover"]); ?>" data-setup="{1}">
          <source src="/share/<?php echo ($videoItem[$videoItemID]["addr"]); ?>" type='video/mp4' />
        </video>
...
<script type="text/javascript" src="/share/Public/Home/js/video.js"charset="utf-8"></script>
<script>
    $(function(){
