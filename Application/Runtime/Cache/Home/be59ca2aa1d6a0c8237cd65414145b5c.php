...
<div class="container uploader_main">
    <div class="uploader_body">
        <h3 class="text-center">E8内部视频上传</h3>
        <form action="<?php echo U('Uploader/uploadVideoInfo');?>"enctype="multipart/form-data" method="post">
            <div>
                <!--左-->
                <div class="uploader_body_l col-lg-8">
                    <div>
                        <div class="form-group">
                            ...
                            <input type="text" name="videoName" class="form-control" id="exampleInputEmail1" placeholder="输入文件的名称">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">File Describe</label>
                            <textarea name="videoIntro" class="form-control" id="exampleInputPassword1" rows="3" placeholder="输入文件的描述"></textarea>
                        </div>
                        <!--
                        <div class="form-group">
                ...
                <div class="uploader_body_r pull-right col-lg-4 col-md-12 col-sm-12">
                    ...
                    <div class="file_classify">
                        ...
                        <div>
                            <?php if(is_array($categroy)): $i = 0; $__LIST__ = $categroy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$firstCategroy): $mod = ($i % 2 );++$i;?><h5><?php echo ($firstCategroy["name"]); ?></h5>
                                <div class="form-group">
                                     <?php if(is_array($firstCategroy["child"])): $i = 0; $__LIST__ = $firstCategroy["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$twoCategroy): $mod = ($i % 2 );++$i;?><label class="checkbox-inline">
                                             <input type="checkbox" name="categroy[]" id="inlineCheckbox1" value="<?php echo ($twoCategroy['id']); ?>"><?php echo ($twoCategroy['name']); ?>
