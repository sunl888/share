...
<head>
    ...
    <link href="/share/Public/Home/css/webuploader.css" rel="stylesheet">
...
<script src="/share/Public/Home/js/webuploader.min.js"></script>
<script>
 $(function(){
    var $list = $('#thelist');
    var uploader = WebUploader.create({
        ...
        // swf文件路径
        swf: '/share/Public/Home/js/Uploader.swf',
        chunked: false,
        // 文件接收服务端。
